...
func (m *Mail) buildHTMLMessage(msg Message) (string, error) {
	templateToRender := fmt.Sprintf("./project_email/cmd/web/templates/%s.html.gohtml", msg.Template)
...
func (m *Mail) buildPlainTextMessage(msg Message) (string, error) {
	templateToRender := fmt.Sprintf("./project_email/cmd/web/templates/%s.plain.gohtml", msg.Template)
